			...
			<div class="relative w-full overflow-hidden">
				...
				>
					{#each displayCollections as category}
						...
						>
							<div
								class="relative flex h-[4.5rem] w-[4.5rem] items-center justify-center overflow-hidden rounded-full bg-[#f5f0e5] ring-1 ring-[#0a0a0a]/10 transition-all duration-300 group-hover:-translate-y-1 group-hover:shadow-[0_8px_20px_rgba(20,53,45,0.15)] group-hover:ring-2 group-hover:ring-[#c5a880] sm:h-[7.5rem] sm:w-[7.5rem]"
							>
								<img
							...
							<span
								class="text-center font-serif text-[0.65rem] font-semibold tracking-[0.1em] text-[#0a0a0a] uppercase transition-colors group-hover:text-[#c0983f] sm:text-xs"
							>
								{category.name}
							</span>
						</a>
