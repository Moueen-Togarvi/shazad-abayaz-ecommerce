...
<section class="relative overflow-hidden border-y border-[#0a0a0a]/8 bg-white py-5 sm:py-7">
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		<div
			class="relative grid min-h-[480px] overflow-hidden rounded-[1.75rem] border border-[#d4d4d4]/45 bg-[#141414] shadow-[0_22px_50px_rgba(0,0,0,0.18)] sm:min-h-[390px] lg:grid-cols-[0.72fr_1.28fr]"
		>
			<div class="pointer-events-none absolute inset-0 bg-[linear-gradient(120deg,#3a3a3a_0%,#242424_24%,#141414_48%,#0a0a0a_100%)]"></div>
			...
			<div class="pointer-events-none absolute top-10 right-8 hidden text-[#d9d9d9]/75 sm:block">
			...
			<div
				class="relative z-10 flex min-h-[330px] items-end justify-center overflow-hidden border-b border-[#e0e0e0] bg-white px-4 pt-6 lg:min-h-full lg:border-r lg:border-b-0"
			>
				<div class="pointer-events-none absolute inset-y-0 left-0 w-4 bg-[#a3a3a3] sm:w-6"></div>
				<div class="pointer-events-none absolute inset-y-0 right-0 w-4 bg-[#f0f0f0] sm:w-6"></div>
				<svg
					class="pointer-events-none absolute inset-0 text-[#8a8a8a]/28"
					viewBox="0 0 420 430"
				...
				<div
					class="relative z-10 mb-0 h-[300px] w-[84%] max-w-[380px] overflow-visible rounded-t-full border border-[#d9d9d9] bg-[#eee4dc] shadow-[0_18px_38px_rgba(0,0,0,0.14)] sm:h-[390px] lg:h-[88%] lg:w-[82%]"
				>
					<div class="pointer-events-none absolute inset-3 rounded-t-full border-t-[8px] border-l-[8px] border-r-[8px] border-[#e0e0e0]"></div>
					...
					<div
						class="absolute -right-7 top-10 z-20 flex size-24 flex-col items-center justify-center rounded-full border-2 border-[#d4d4d4] bg-[#1a1a1a] text-center text-white shadow-[0_14px_30px_rgba(0,0,0,0.25)] sm:-right-8 sm:size-28"
					>
					...
					<span
						class="absolute bottom-3 left-3 z-20 rounded-md bg-[#1a1a1a] px-4 py-2 text-xs font-black text-white uppercase shadow-[0_10px_24px_rgba(0,0,0,0.25)] sm:px-5 sm:text-sm"
					>
						Online Exclusive
					</span>
				</div>
			...
			<div class="relative z-10 flex flex-col items-center justify-center px-5 py-7 text-center sm:px-10 lg:px-14">
				...
				<div class="relative">
					...
					<p
						class="-mt-2 font-serif text-[2.05rem] leading-none text-[#d4d4d4] italic sm:-mt-4 sm:text-[3.35rem] lg:text-[3.8rem]"
					>
						{settings.flashSaleSubtitle || 'Ends soon!'}
					</p>
				</div>

				<div class="mt-4 flex w-full max-w-2xl items-center gap-3 text-[#d9d9d9]">
				...
				<div class="mt-5 w-full max-w-[31rem] rounded-2xl border border-[#d4d4d4]/55 px-4 py-3 sm:px-6">
					<div class="-mt-6 mb-2.5 flex items-center justify-center gap-3">
						<span class="hidden h-px w-20 bg-[#d9d9d9]/60 sm:block"></span>
						<span class="bg-[#1a1a1a] px-3 text-[0.68rem] font-black text-white uppercase">
							Remaining Time:
						</span>
						<span class="hidden h-px w-20 bg-[#d9d9d9]/60 sm:block"></span>
					</div>
						...
						<div class="flex flex-col items-center gap-2">
							<div class="flex gap-1.5">
								{#each pad(hours) as digit}
									<div
										class="flex h-12 w-9 items-center justify-center rounded-lg bg-white text-2xl font-black text-[#1a1a1a] shadow-[0_8px_18px_rgba(0,0,0,0.25)] tabular-nums sm:h-15 sm:w-12 sm:text-3xl"
									>
										{digit}
									</div>
								{/each}
				...
				<a
					...
					class="mt-5 inline-flex min-h-11 items-center justify-center gap-3 rounded-full border border-white/50 bg-white/90 px-9 text-sm font-black text-[#1a1a1a] uppercase shadow-[0_0_24px_rgba(0,0,0,0.18)] transition-colors duration-200 hover:bg-[#e5e5e5] sm:min-h-12 sm:px-14"
				>
