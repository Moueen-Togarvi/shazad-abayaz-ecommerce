			...
			<div class="min-w-0 flex-1">
				...
				{:else}
					...
					>
						...
						<a
							href="/shop"
							class="mt-6 inline-flex min-h-11 items-center justify-center rounded-full bg-[#0a0a0a] px-6 text-sm font-bold text-white transition-colors hover:bg-[#c5a880] hover:text-[#0a0a0a]"
						>
							Clear Filters
						</a>
					</div>
				...
				<div
					class="mt-14 border-t border-[#0a0a0a]/10 pt-8 text-center text-sm font-bold text-[#52524f]"
				>
				...
				{#if pagination.totalPages > 1}
					<nav
						class="mt-8 flex flex-col items-center justify-between gap-4 text-sm font-bold text-[#0a0a0a] sm:flex-row"
