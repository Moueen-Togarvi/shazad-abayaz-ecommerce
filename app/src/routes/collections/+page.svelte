	...
	<div class="mx-auto max-w-7xl">
		<div class="mb-8 border-b border-[#0a0a0a]/10 pb-8">
			...
			<div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
				...
				<label class="relative block w-full max-w-lg">
					...
					<span class="pointer-events-none absolute top-1/2 left-4 -translate-y-1/2 text-[#52524f]">
					...
					<input
						...
						class="min-h-12 w-full rounded-full border border-[#0a0a0a]/10 bg-white pr-4 pl-11 text-sm font-bold text-[#0a0a0a] shadow-[0_14px_34px_rgba(20,53,45,0.07)] placeholder:text-[#52524f]/60 focus:border-[#0a0a0a] focus:ring-[#0a0a0a]"
					/>
				</label>
			</div>
		</div>
		...
		<div class="mb-6 flex flex-wrap items-center justify-between gap-3">
			...
			{#if categorySearch}
				<button
					type="button"
					class="rounded-full border border-[#0a0a0a]/10 bg-white px-4 py-2 text-xs font-black tracking-[0.12em] text-[#0a0a0a] uppercase transition-colors hover:bg-[#0a0a0a] hover:text-white"
			...
			<div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
				{#each filteredCollections as collection, index}
					<a
						...
						class="group overflow-hidden rounded-md border border-[#0a0a0a]/10 bg-white shadow-[0_18px_42px_rgba(20,53,45,0.1)] transition-transform duration-300 hover:-translate-y-1"
					>
						<div class="relative aspect-[4/3] overflow-hidden bg-[#eeece4]">
							...
							/>
							<div
								class="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#0a0a0a]/82 to-transparent p-4"
							>
								<span
									class="inline-flex rounded-full bg-white/92 px-3 py-1 text-[0.66rem] font-black tracking-[0.12em] text-[#0a0a0a] uppercase"
								>
						...
						<div class="p-5">
							<div class="flex items-start justify-between gap-4">
								<h2
									class="font-serif text-2xl leading-tight text-[#0a0a0a] transition-colors group-hover:text-[#a8895f]"
								>
									{collection.name}
								</h2>
								<span
							...
							<p class="mt-5 text-xs font-black tracking-[0.14em] text-[#a8895f] uppercase">
								Shop Category
							</p>
						</div>
					</a>
		...
		{:else}
			<div
				class="rounded-md border border-[#0a0a0a]/10 bg-white p-10 text-center shadow-[0_16px_38px_rgba(20,53,45,0.08)]"
			>
				<p class="font-serif text-2xl text-[#0a0a0a]">No categories found</p>
				<p class="mt-3 text-sm font-medium text-[#52524f]">Try another category name.</p>
			</div>
		{/if}
	</div>
</section>
